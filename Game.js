...
for(var plr in allPlayers) {
    if(allPlayers[plr].rank===1){
        text(allPlayers[plr].name,x+100,y+50)
        image(firstPlaceMedalImage,x-50,y,100,100)
    }
    else if(allPlayers[plr].rank===2){
        text(allPlayers[plr].name,x+100,y+200)
        image(goldMedalImage,x-50,y+200,100,100)
        
    }
    else if(allPlayers[plr].rank===3){
        text(allPlayers[plr].name,x+100,y+300)
        image(silverMedalImage,x-50,y+300,100,100)
    }
    else if(allPlayers[plr].rank===4){
        text(allPlayers[plr].name,x+100,y+400)
        image(bronzeMedalImage,x-50,y+400,100,100)
    }
